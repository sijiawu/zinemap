...
slug: the-feminist-bookstore-behind-the-zine-scenes
excerpt: "A conversation with Aleah, who runs the bookstore's zine rack, about building a self-managed, creator-first space where all proceeds stay with the artists."
---

<Callout>[**The Feminist Bookstore**](https://zinemap.com/store/the-feminist-bookstore-san-diego) was one of the earliest San Diego shops to add itself to ZineMap. The listing highlights an artist-run zine section where creators keep all proceeds, manage their own stock, and handle their own payment methods. The rack is currently maintained by **Aleah**, a zinester whose own path into DIY publishing began after joining the shop. I reached out to learn how this setup took shape, how curation works, and the kinds of community connections that grow around it.</Callout>
...
**I saw that you tabled at events like [San Diego Zine Fest](https://zinemap.com/event/san-diego-zine-fest-san-diego). What does being part of the San Diego zine scene look like for you personally?**\
...
**I’d love to ask how you found [ZineMap](https://zinemap.com), since you’re one of the few shops that added yourselves!**\
...
<Callout>A huge thank you to **Aleah** and [**The Feminist Bookstore**](https://zinemap.com/store/the-feminist-bookstore-san-diego) for sharing their story. You can support them by checking out the shop and explore their artist-run rack next time you're in San Diego! And if you’re looking for more zine shops, libraries, and festivals, [**ZineMap**](https://zinemap.com) is growing every day - come find your people :) </Callout>
