...
<ImageWithCaption
  src="la-fanzinotheque-genevoise/topos.jpg"
  alt="Inauguration du Quatre avec l’association Topos, juin 2025"
  caption="Inauguration du Quatre avec l’association Topos, juin 2025. Photos : Greg Clément"
/>
...
When Stef replied to my thank-you email for her ZineMap contribution saying “write to me when you come through Geneva”, I didn’t expect to be couchsurfing at her and her partner’s place a mere two months later, just in time for the Escalade weekend. She showed me around town: we visited a few zine and comics bookshops, and spent some time at the current storage space of FanzinoGE on rue Louis Favre.  I also tagged along for [**a zine workshop at the Ferme de la Chapelle**](https://fanzino-ge.ch/nos-corps-perceptibles-ferme-de-la-chapelle-11-nov-14-dec-2025/) that she was leading. Back from the workshop, Stef and I sat down at her dining table for this interview - the official excuse for my visit:</Callout>
...
**Stef:** I first discovered zines when I was around sixteen or eighteen, in the early 2000s, through underground, punk, and comics scenes, and I collected a few of them. One day I had to move, and I took my paperback books with me, but I didn't take my zines, because I didn't think they were important. That was a big mistake. Those zines were impossible to find again.

**CJ:** And you can find paperbacks everywhere!

**Stef:** Exactly. That's kind of the origin story. That’s when I realized how rare and precious zines are, compared to commercially published books. After that things took their own course: I studied art, became interested in artist books and publishing, and after leaving school I founded [**La Mouche**](https://lamouche.ch), a collective zine journal that's now been running for 11 years. It became a way to meet people, build networks, and have fun. It's a space of freedom.
...
**Stef:** Yes, in February and March 2025 there was [**an installation at the Centre d'Art Contemporain, at Le Commun**](https://renaissance.ooo/8-work-bookishness-). That was really a great experience. We exhibited about 200 zines, which was about 10% of the collection on display. There was a big table where everyone could make zines and it worked really well. After that there was [**the Élise Gagnebin de Bons exhibition in Lancy**](https://fanzino-ge.ch/nos-corps-perceptibles-ferme-de-la-chapelle-11-nov-14-dec-2025), where the artist asked the Fanzinothèque to make a selection related to her work and put it out for consultation in the institution. A few zines were also sent on loan to Paris Sciences et Lettres University for [**an exhibition on zines**](https://fanzino-ge.ch/exposition-fanzines-universite-psl-paris-mazet-9-oct-16-decembre-2025/). It’s an opportunity to present the project, meet people, collect new zines, and explain how to make them. In the end it’s all about meeting people and building connections.
...
**Stef:** Today collective work is complicated because we don't have a meeting space. The collection is kept in a basement, closed to the public, and we only bring it out in small portions for one-off events. But we have a partnership with [**Topos Acacias**](https://topos-acacias.ch/), another Geneva-based association that focuses on connecting artists, art, and culture with local residents. They’re based in a neighborhood currently undergoing major redevelopment, with demolitions and new housing projects underway. We run a workshop with them once a month as a co-production. For us, it provides a space to present fanzines, and for them it creates opportunities for community engagement and encounters. Sometimes we invite artists; other times we simply bring zines and make zines together.

**CJ:** Has that already started?

**Stef:** Yes, we started in November with the artist [**Ben Comix**](https://fanzino-ge.ch/atelier-fanzine-avec-ben-comix-en-collaboration-avec-topos-acacias-15-nov-2025/) who makes comix zines. The second one was about territory and the city, so we worked on map-style folds. The next one is at the end of January, then another at the end of February, then March, all the way through June. [**It's all announced on our website**](https://fanzino-ge.ch/ateliers-fanzines-chez-topos-acacias-28-fevrier-11-mars-25-avril-20-mai-27-juin/). The program isn’t completely finalized yet, but the idea is to invite people who work in drawing, micro-publishing, or printing to share their process and create together with everyone. In summer it will be especially nice because there’s an outdoor space.

<ImageWithCaption
  src="la-fanzinotheque-genevoise/topos.jpg"
  alt="Topos opening in June 2025."
  caption="Topos opening in June 2025. Photos: Greg Clément"
/>
...
**Stef:** Yes, I think so (laughs). But it’s impressive because it’s really changing the scale of the project. At the beginning there was almost nothing: no money, not many members, a little under 1,000 zines, not sorted, not organized, and no inventory. Now we have categories, a fairly well-documented inventory, we’re starting to work on the catalogue, we have volunteers, we’ve had interns, and we’ve had partnerships with the Haute école de Gestion. So it’s growing very quickly. But we need an actual space to really work collectively and in good conditions. So for now we’re crossing our fingers and waiting to see what happens at the end of February and later this summer.

**CJ:** Good luck!

**Stef:** (laughs) But so far, things have always worked out pretty well. In fact, it’s the only zine library in Switzerland. Geneva has a particularly rich history of comics, micro-publishing, and alternative publishing dating back to the 1970s. It’s an important heritage, but one that’s very difficult to collect, access, or research. That’s why it’s such a great opportunity to have an independent association that can connect this scattered underground scene with institutions, and above all with the public. The goal is to tell this history: all those voices that were never heard, that nobody knows about, or that people have forgotten, even though they are part of that history and are important too.

**CJ:** Are there examples of zines that record these kinds of histories?

**Stef:** In some older publications there’s *Étagères* by Simon Tschopp, a really interesting fanzine somewhere between drawing, art, and illustration, which also touches on street art. In comics there was *Sauve qui peut*, where many contributors later went on to other things. *Le Zombie Libéré* came shortly afterward, and the same person, Marc, was involved in both. There has always been a crossover between comics, music, punk, and anarchism. And there were also the squat movements and associations of poorly housed residents, who produced their own bulletins and told their own versions of the clashes and evictions, along with the cultural programming around them, like concerts, protests and film screenings. For example *Roberta* from the intersquat editions, and *Je sais tout*. They contained information you simply couldn’t find elsewhere. Looking back today, it’s striking to realize: “Oh yes, that happened. There used to be a place like that, and it disappeared… because of real estate.”
...
**Stef:** Racism too, that’s another theme that keeps coming up. It’s interesting to look back at past struggles and draw inspiration from them. It’s also fascinating to see how the techniques have evolved – the papers, the formats… from typewriters to computers, and now all these non-binary typefaces and open-source fonts. For example, there’s the collective [**Bye Bye Binary**](https://typotheque.genderfluid.space/fr), whose fonts are used in many different publications. We have many artists’ publications experimenting with these tools as well. It’s a very lively scene.
...
**Stef:** In Switzerland, like in many countries, fanzines have been the medium that allows you to review bands, list concerts, and interview all these bands that play in basements. A big part of the Fanzinothèque’s collection is about music, of all genres, with plenty of punk too, obviously. That’s actually where I discovered fanzines — at concerts. It was the kind of information you couldn’t really find anywhere else.
...
**Stef:** Yes. Obviously you don’t have to be a librarian or archivist to start a zine library, but at some point you do need some knowledge of cataloguing, how to record information properly. Especially with objects like zines, where sometimes there’s no name, no title, no date, no place… The details that allow you to identify them can be very difficult to determine. And because these publications are quite underground and printed in very small numbers, people don’t even know they exist. So how would anyone ever find them? They need to be described, tagged with keywords, and placed in context. Structuring that information is something I learned during my studies.
...
**Stef:** Mostly it’s about letting people know this project exists. Many people have zines sitting on their shelves, barely organized, which bothers them a little bit, but they don’t want to throw them away. So the more recognized we become, the more people trust us. They see that the work is serious and carefully done, so they come and donate their zines. It’s wonderful. That’s how we’ve received zines from the 1980s. I wasn’t even born yet in 1980 (laughs). It allows us to recover small pieces of history. Also creators have been sending us copies of their zines, which is amazing, huge thanks by the way! It’s also worth mentioning that we’re not focused only on Swiss fanzines. The idea is also to encourage creation and support young artists. Membership fees help us purchase copies from tables at festivals and openings. Of course we have to make choices, so the aim is to represent a wide range of styles, genres, and topics. But inevitably the collection remains partial and somewhat random, because so much depends on encounters.

**CJ:** What percentage of zines are purchased?

**Stef:** Ah, that’s a difficult question! Maybe around 30%. It depends on the year, because at the very beginning the entire collection was donated – by myself, I mean. After that, some people thought, “Great, this is the perfect moment to get rid of all my zines!” and donated entire bags of them. Sometimes there are festivals with lots of interesting things, so if we have the means we buy quite a lot at once. Sometimes there are exchanges. It really varies. But in the end, once the catalogue is finished, we’ll be able to see clearly what was donated and what was purchased. The collection grows by about 1,000 zines per year, which is a lot! And we have to keep up with cataloguing them, identifying them, and preserving them properly…

**CJ:** Which is a lot of work, I imagine.

**Stef:** Yes, it’s invisible labor, but it’s the foundation of everything. The catalogue will also become a kind of showcase for collectives, creators, and researchers working on social, cultural, or political topics. We need the right information so people know where to look and what to look for. There are also workshops for people to make zines on site, which then become part of an archive of zines produced in situ. But that’s not the majority.

<ImageWithCaption
  src="la-fanzinotheque-genevoise/depot.jpg"
  alt="Current view of the Fanzinothèque collection in the depot"
  caption="Current view of the Fanzinothèque collection in the storage space where everything is meticulously organized. The brown chair in the corner is where sorting currently happens. Photo: CJ Wu"
/>
...
**Stef:** Yes and no, because everything had to be invented from scratch. There was a lot of tedious work that I did not dare ask others to do for free, so I took on most of it myself. But it was my obsession, my project, and because I had studied this field, I knew what needed to be done. What works well are partnerships with universities. Those who study to become librarians have a course where a group works on a real assignment for half a day each week throughout the semester. For them it counts as academic credit, and for us it helps move specific projects forward. For example, the very first inventory and the categories were created with four students from the HEG. We also receive quite a few requests from interns in art schools, comics programs, or library studies, but we can’t realistically host anyone properly right now if we don’t have windows.
...
<ImageWithCaption
  src="la-fanzinotheque-genevoise/stagiaire.jpg"
  alt="An intern from ESBDI (Geneva School of Comics and Illustration) making short Instagram videos at L'Usine, August 2024, August 2024"
  caption="An intern from ESBDI (Geneva School of Comics and Illustration) making short Instagram videos at L'Usine, August 2024. Photo: Stef Probst"
/>

**CJ:** Apart from having windows, what would the ideal future space for the Fanzinothèque look like?

**Stef:** Ideally, there would be movable shelving so the space could be reconfigured into quiet reading areas or discussion areas with cushions and seating. It should be accessible to people using wheelchairs or canes. There would be a consultation and welcome area for the collection, a space for creation, and a professional photocopier available at cost so that anyone can access the tools to make things. And walls for exhibitions. What would be wonderful too is a big garden with lounge chairs, but in Geneva that might be a bit difficult (laughs).
...
**Stef:** Ideally it should be collective and fully self-managed. Right now I’m the one driving the project forward, because I’m a bit obsessive and I coordinate a lot of things. But I’m not always right about everything. Having a space where people can talk, experiment, and try different approaches would make the Fanzinothèque richer, more diverse, more inclusive, and more fun. At the same time, it still has to remain organized, because the whole point is that people need to be able to find what they’re looking for. That’s why the catalogue is fundamental.

**CJ:** What are the challenges of being in Switzerland?

**Stef:** Switzerland is a small country, but it’s quite complex because every canton has its own culture. In Geneva we speak French and we’re very close to France, so part of the collection here comes from France and Belgium. But most of the country speaks German, then Italian, and there’s also Romansh, which is the rarest. The real challenge would be crossing those language barriers. For now, the Fanzinothèque is Genevan, so it’s local. What would be great is to have branches in different places, with each branch taking care of its own local scene and then exchanging with the others. For example, there are collectives making zines in Fribourg, but it’s difficult for people in Geneva to attend their openings. If there were a team there sending us their zines, we could exchange with them, or with groups in Zurich, Ticino, Bern, or Biel. There are many small underground scenes, but because we don’t speak the same language, we don’t really know what’s happening. Many Swiss creators make zines in English or speak English with each other, so we also meet through those English-language zines, or sometimes multilingual ones. It’s a great way to share cultural differences: in Geneva we have Lake Geneva, the Jet d’Eau, the Battle of the Escalade commemoration, and a more Protestant culture; in Valais it’s Catholic, with mountains and raclette, and so on. The zine could be a medium for sharing those differences, but that’s a vision for the future.

**CJ:** And for people in Switzerland or elsewhere who want to support or contribute to this project, what can they do?

**Stef:** The first thing people can do to support the Fanzinothèque is simply to talk about it, because it’s still not very well known. For those who want to get more involved, you can also become a member. There’s an annual membership fee, adjusted depending on what people can afford. The idea is that everyone contributes a little money so that together we can maintain a much larger collection than any of us could build on our own. And of course, one can always support by donating zines to the collection!

**CJ:** How much does the membership cost?

**Stef:** The membership fee is 20 francs a year for students or people with modest incomes. We don’t check. The standard rate is 40 francs. If someone wants to contribute more, that’s also possible, and the extra goes toward acquiring fanzines or organizing events. Anyone who pays the fee becomes a member, and because we’re an association, that means members can vote at the general assembly, participate in discussions, and propose ideas. People can also volunteer, whether that’s helping hold a stall, leading workshops, or cataloguing.

**CJ:** Can someone become a member without living in Geneva?

**Stef:** Of course, for the glory of being part of the Fanzinothèque! In return for the membership fee, members are kept informed about how things work, administrative matters, votes, financial transparency. And of course there’s the membership card…

**CJ:** And stickers.

**Stef:** And stickers. What we’re looking at now, to bring in some funding, is making stickers, badges, small goodies, producing zines… things people can get in return for supporting us, but that are handmade, creative and meaningful objects. We’re not going to make baseball caps (laughs), but things connected to what we do.
...
**CJ:** Is there anything the Fanzinothèque turns away?

**Stef:** Sometimes when we’re sorting donations, there’s a bag with all kinds of things inside. For example, there might be *Fluide Glacial*, which can be found elsewhere, so there’s no need for the Fanzinothèque to preserve it. Some informational or activist pamphlets from infokiosques are often already available online as PDFs. There’s [**another association in Geneva**](https://www.infokiosques.net/) that already handles that side of things very well. One of our criteria is that the publication contains some form of creation or testimony, not simply a printed article or a chapter turned into a pamphlet. If there’s problematic content, we do accept it if it meets the production criteria, but we might choose not to highlight it, or we might include a content warning. It’s part of a particular moment and a particular publishing practice. Even if it’s produced by an extreme-right group, or contains dangerous medical advice, it’s still part of what exists and therefore part of alternative, experimental, and independent publishing practices. The idea is not to judge the subject matter, but to be careful not to place potentially harmful information in everyone’s hands. Incitement to hatred, for example, is completely against our values. If a hateful zine comes in, it can still be relevant for research, to show that these documents circulate, that they exist, that they’re produced in the form of a zine. But of course we wouldn’t put it on display. So we don’t destroy things or throw things away, but we are careful about what we choose to present.

<ImageWithCaption
  src="la-fanzinotheque-genevoise/stef.jpg"
  alt="Zine workshop at Ferme de la Chapelle, December 14, 2025"
  caption="At the zine workshop on December 14, 2025 at [**Ferme de la Chapelle**](https://fanzino-ge.ch/nos-corps-perceptibles-ferme-de-la-chapelle-11-nov-14-dec-2025/), Stef experimented with a new fold from a large magazine spread before participants arrived. Photo: CJ Wu"
/>
