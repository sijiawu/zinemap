      ...
      <footer className="bg-white border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 py-8 text-center">
          <p className="text-stone-600 text-sm">
            © 2025 zinemap. created by <a href="cjwucomics.com" target="_blank" className="text-rose-500 hover:text-rose-600">@cjmakescomics</a> with love to fellow indie publishers and the shops and libraries that carry our work!
          </p>
        </div>
      </footer>
    </div>
