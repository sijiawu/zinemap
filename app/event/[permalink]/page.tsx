...
export default function EventDetailPage() {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      ...
      if (event && event.id === params.permalink) {
        return
      }
      ...
      try {
        ...
        if (eventError || !eventData) {
          ...
          if (eventError?.code === 'PGRST116') {
            setError(`Event not found: ${params.permalink}`)
