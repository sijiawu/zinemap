...
export function Callout({ children, variant = 'default' }: CalloutProps) {
  if (variant === 'highlight') {
    return (
      <blockquote className="my-5 sm:my-8 pl-6 pr-8 py-6 bg-rose-50/70 rounded-r-xl border-l-4 border-rose-500 shadow-sm [&_p]:mb-0">
  ...
  return (
    <div className="my-5 sm:my-8 p-6 bg-stone-50 border border-stone-200 rounded-lg">
